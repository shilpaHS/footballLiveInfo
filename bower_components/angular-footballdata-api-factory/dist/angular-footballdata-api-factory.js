...
angular.module("jtt_footballdata", [])
    .factory('footballdataFactory', ['$http', 'footballdataSearchDataService', function ($http, footballdataSearchDataService) {
        ...
        footballdataFactory.getCompitions = function (_params) {

            var searchData = footballdataSearchDataService.getNew("getCompitions", _params);
            console.log("searchData" + angular.toJson(searchData))
        ...
        footballdataFactory.getLeagueCompitions = function (_params) {
            var searchData = footballdataSearchDataService.getNew("getLeagueCompitions", _params);
            return $http({
                method: 'GET',
                url: searchData.url,
                params: searchData.object,
        ...
        footballdataFactory.getTeamsCompitions = function (_params) {
            var searchData = footballdataSearchDataService.getNew("getTeamsCompitions", _params);
            return $http({
                method: 'GET',
                url: searchData.url,
                params: searchData.object,
        ...
        this.getNew = function (_type, _params) {
            ...
            switch (_type) {
                ...
                case "getCompitions":
                    ...
                    footballdataSearchData.url = this.getApiBaseUrl(_params.protocol) + 'competitions/';
                    break;

                case "getLeagueCompitions":
                    footballdataSearchData = this.fillDataInObjectByList(footballdataSearchData, _params, [
                        'apiKey',
                    ]);
                    footballdataSearchData.url = this.getApiBaseUrl(_params.protocol) + 'competitions/' + _params.id + '/leagueTable';
                    break;

                case "getTeamsCompitions":
                    footballdataSearchData = this.fillDataInObjectByList(footballdataSearchData, _params, [
                        'apiKey',
                    ]);
                    footballdataSearchData.url = this.getApiBaseUrl(_params.protocol) + 'competitions/' + _params.id + '/teams';
                    break;
